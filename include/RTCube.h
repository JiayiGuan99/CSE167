...
public:
    void init(void)
    {
        ...
        {
            Triangle t;
            t.P.push_back(glm::vec3(positions[indices[i]][0], positions[indices[i]][1], positions[indices[i]][2]));
            t.P.push_back(glm::vec3(positions[indices[i + 1]][0], positions[indices[i + 1]][1], positions[indices[i + 1]][2]));
            t.P.push_back(glm::vec3(positions[indices[i + 2]][0], positions[indices[i + 2]][1], positions[indices[i + 2]][2]));
